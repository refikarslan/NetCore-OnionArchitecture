...
namespace NetCore_OnionArchitecture.Domain.Common.Repositories
{
        ...
        where TEntity : class, IEntity<TPrimaryKey>
    {
        ...
        public virtual TEntity Get(TPrimaryKey id)
        {
            ...
            if (entity == null)
            {
                throw new Exception($"{typeof(TEntity)}, id = {id} not found");
            }
        ...
        public abstract Task<IEnumerable<TEntity>> GetPagedReponseAsync(int pageNumber, int pageSize);

        //public abstract Task<IEnumerable<TEntity>> GetPagedAdvancedReponseAsync(int pageNumber, int pageSize, string orderBy, string fields);

        //public abstract Task<IEnumerable<TEntity>> GetAllAsync(string fields);
    }
